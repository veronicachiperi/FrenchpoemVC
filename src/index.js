...
function generateProgram(event) {
  ...
  let context = "You are an expert in nutrition. Your mission is to generate 3 day nutrition programs based on user weight in basic HTML, separating each day by <br> and each day of the week being below one another. Make sure to follow the user weight. Do not include a title to the program. Sign the program with 'VC' inside a <strong> element at the end of the program and NOT at the beginning";
