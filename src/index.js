...
function generateProgram(event) {
  ...
  let context = "You are an expert in nutrition. Your mission is to generate 3 day nutrition programs with quantities based on user weight in basic HTML, arrange the text in a HTML TABLE. Make sure to follow the user weight. Do not include a title to the program. Sign the program with 'VC' inside a <strong> element at the end of the program and NOT at the beginning";
